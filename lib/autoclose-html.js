        ...
        toggleAutoclose: function(activate) {
            ...
            if(this.active) {
                ...
                atom.workspaceView.eachEditorView(function(editorView){
                    ...
                    editorView.data('enableFcn', enableFcn);
                    editorView.off('editor:grammar-changed', enableFcn).command('editor:grammar-changed', {}, enableFcn).trigger('editor:grammar-changed');
                    console.log(editorView);
                });
                
            } else {
                if(editorView.data('enableFcn')) {
                    atom.workspaceView.eachEditorView(function(editorView){
                        editorView.off('editor:grammar-changed', editorView.data('enableFcn'));
                    });
                }
